...
flags.DEFINE_string('rtsp', None, 'rtsp stream url')
...
def predict_age_and_gender(_argv):
    """Predict the gender of the faces showing in the image"""
    # create a new cam object
    if FLAGS.rtsp is not None:
    ...
    while True:
        ...
        frameBase64 = Utils.imageToBase64(frame)
        jsonResult = json.dumps(
            {'frame': str(frameBase64)})
...
if __name__ == "__main__":
    app.run(predict_age_and_gender)
